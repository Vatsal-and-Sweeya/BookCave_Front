...
# # SECURE_SSL_REDIRECT = True #redirection protocol https://www.chosenplaintext.ca/articles/why-hsts.html and https://really-simple-ssl.com/knowledge-base/clear-hsts-browser/
...
# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-uo8&n4md1+&nw8y+s#=7nm!l6p=2cqr+-=xzzn81d$jn9v7+@4'
